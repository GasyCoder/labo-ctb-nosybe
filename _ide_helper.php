...
namespace Devrabiul\ToastMagic\Facades {
    ...
    class ToastMagic {
        ...
        {
            /** @var \Devrabiul\ToastMagic\ToastMagic $instance */
         ...
         * @static
         */
        public static function add($type, $message, $description = null, $options = [])
        {
            /** @var \Devrabiul\ToastMagic\ToastMagic $instance */
            $instance->add($type, $message, $description, $options);
        }
         ...
         * @static
         */
        public static function info($message, $description = null, $options = [])
        {
            /** @var \Devrabiul\ToastMagic\ToastMagic $instance */
            $instance->info($message, $description, $options);
        }
         ...
         * @static
         */
        public static function success($message, $description = null, $options = [])
        {
            /** @var \Devrabiul\ToastMagic\ToastMagic $instance */
            $instance->success($message, $description, $options);
        }
         ...
         * @static
         */
        public static function warning($message, $description = null, $options = [])
        {
            /** @var \Devrabiul\ToastMagic\ToastMagic $instance */
            $instance->warning($message, $description, $options);
        }
         ...
         * @static
         */
        public static function error($message, $description = null, $options = [])
        {
            /** @var \Devrabiul\ToastMagic\ToastMagic $instance */
            $instance->error($message, $description, $options);
        }
