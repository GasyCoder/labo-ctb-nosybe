    ...
    <div class="bg-blue-50 dark:bg-blue-900/20 px-6 py-4 border-b border-gray-200 dark:border-gray-600 rounded-t-xl">
        <h6 class="font-semibold text-blue-900 dark:text-blue-200 flex items-center">
            ...
            @if ($createWithChildren)
                <span
                    class="ml-2 text-sm bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200 px-2 py-1 rounded-full">
                    avec sous-analyses
                </span>
            @endif
        </h6>
    ...
    <div class="p-6">
        <form wire:submit.prevent="store" class="space-y-8">
            ...
            <div class="border border-gray-200 dark:border-gray-600 rounded-lg p-6 bg-gray-50 dark:bg-gray-700/50">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="text"
                            ...
                            id="code" wire:model="code" placeholder="Ex: GLY">
                        @error('code')
                            ...
                            <select wire:model="parent_id"
                                ...
                                @if ($analysesParents)
                                    @foreach ($analysesParents as $parent)
                                        <option value="{{ $parent->id }}">{{ $parent->code }} -
                                            {{ $parent->designation }}</option>
                                    @endforeach
                                @endif
                            </select>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    <div>
                        ...
                        <input type="text"
                            ...
                            id="designation" wire:model="designation" placeholder="Ex: Glycémie">
                        @error('designation')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01"
                            ...
                            id="prix" wire:model="prix" placeholder="0.00">
                        @error('prix')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-6">
                        ...
                        <select wire:model="examen_id"
                            ...
                            @if ($examens)
                                @foreach ($examens as $examen)
                                    <option value="{{ $examen->id }}">{{ $examen->abr }} - {{ $examen->name }}
                                    </option>
                                @endforeach
                            @endif
                        </select>
                    ...
                    <div>
                        ...
                        <input type="text"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                            id="unite" wire:model="unite" placeholder="Ex: g/l, mmol/l">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                            id="ordre" wire:model="ordre" placeholder="99">
                    </div>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    {{-- Section pour les valeurs de référence --}}
                    <div
                        class="mt-6 border border-blue-200 dark:border-blue-600 rounded-lg p-6 bg-blue-50 dark:bg-blue-900/20">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label for="valeur_ref_homme"
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                        <svg class="w-4 h-4 inline mr-1 text-blue-600" fill="none"
                                    ...
                                    <input type="text"
                                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                                        id="valeur_ref_homme" wire:model="valeur_ref_homme"
                                        placeholder="Ex: 3.89 - 6.05">
                                </div>

                                <div>
                                    <label for="valeur_ref_femme"
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                        <svg class="w-4 h-4 inline mr-1 text-pink-600" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <input type="text"
                                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                                        id="valeur_ref_femme" wire:model="valeur_ref_femme"
                                        placeholder="Ex: 3.89 - 6.05">
                                </div>
                            </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label for="valeur_ref_enfant_garcon"
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                        <svg class="w-4 h-4 inline mr-1 text-blue-400" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m0 0H9" />
                                        </svg>
                                    ...
                                    <input type="text"
                                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                                        id="valeur_ref_enfant_garcon" wire:model="valeur_ref_enfant_garcon"
                                        placeholder="Ex: 3.5 - 5.5">
                                </div>

                                <div>
                                    <label for="valeur_ref_enfant_fille"
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                        <svg class="w-4 h-4 inline mr-1 text-pink-400" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m0 0H9" />
                                        </svg>
                                    ...
                                    <input type="text"
                                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                                        id="valeur_ref_enfant_fille" wire:model="valeur_ref_enfant_fille"
                                        placeholder="Ex: 3.5 - 5.5">
                                </div>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <input type="text"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                            id="suffixe" wire:model="suffixe" placeholder="Suffixe optionnel">
                    </div>
                </div>

                <div class="flex items-center space-x-6 mt-6">
                    <div class="flex items-center">
                        <input type="checkbox" id="is_bold" wire:model="is_bold"
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" id="status" wire:model="status"
                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                            checked>
            ...
            @if ($level === 'PARENT' || $createWithChildren)
                <div
                    class="border border-purple-200 dark:border-purple-600 rounded-lg p-6 bg-purple-50 dark:bg-purple-900/20">
                    <div class="flex justify-between items-center mb-4">
                        <h3 class="text-lg font-medium text-purple-900 dark:text-purple-200 flex items-center">
                            ...
                            @if (count($sousAnalyses) > 0)
                                <span
                                    class="ml-2 bg-purple-200 dark:bg-purple-800 text-purple-800 dark:text-purple-200 px-2 py-1 rounded-full text-sm">
                                    {{ count($sousAnalyses) }}
                                </span>
                            @endif
                        </h3>
                        <button type="button" wire:click="addSousAnalyse"
                                ...
                                <div
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                        <div>
                                            ...
                                            <input type="text" wire:model="sousAnalyses.{{ $index }}.code"
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
                                        <div>
                                            ...
                                            <select wire:model="sousAnalyses.{{ $index }}.examen_id"
                                                ...
                                                @if ($examens)
                                                    @foreach ($examens as $examen)
                                                        <option value="{{ $examen->id }}">{{ $examen->abr }}
                                                        </option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        ...
                                        <div>
                                            ...
                                            <input type="text" wire:model="sousAnalyses.{{ $index }}.unite"
                                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-700 dark:text-white text-sm"
                                                placeholder="Ex: g/l">
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input type="number" wire:model="sousAnalyses.{{ $index }}.ordre"
                                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-700 dark:text-white text-sm"
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                                        ...
                                        <div
                                            class="mt-6 border border-blue-200 dark:border-blue-600 rounded-lg p-6 bg-blue-50 dark:bg-blue-900/20">
                                            <h3
                                                class="text-lg font-medium text-blue-900 dark:text-blue-200 mb-4 flex items-center">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                ...
                                                <div class="space-y-4">
                                                    ...
                                                    <div>
                                                        <label for="valeur_ref_homme"
                                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                                            <svg class="w-4 h-4 inline mr-1 text-blue-600"
                                                    ...
                                                    <div>
                                                        <label for="valeur_ref_femme"
                                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                                            <svg class="w-4 h-4 inline mr-1 text-pink-600"
                                                                fill="none" stroke="currentColor"
                                                                viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-width="2"
                                                ...
                                                <div class="space-y-4">
                                                    ...
                                                    <div>
                                                        <label for="valeur_ref_enfant_garcon"
                                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                                            <svg class="w-4 h-4 inline mr-1 text-blue-400"
                                                                fill="none" stroke="currentColor"
                                                                viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-width="2"
                                                    ...
                                                    <div>
                                                        <label for="valeur_ref_enfant_fille"
                                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                                            <svg class="w-4 h-4 inline mr-1 text-pink-400"
                                                                fill="none" stroke="currentColor"
                                                                viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-width="2"
                                    ...
                                    @if (isset($sousAnalyses[$index]['level']) && $sousAnalyses[$index]['level'] === 'PARENT')
                                        <div class="mt-6 pt-4 border-t border-purple-200 dark:border-purple-600">
                                            <div class="flex justify-between items-center mb-4">
                                                <h5
                                                    class="text-md font-medium text-purple-800 dark:text-purple-300 flex items-center">
                                                    ...
                                                    @if (isset($sousAnalyses[$index]['children']) && count($sousAnalyses[$index]['children']) > 0)
                                                        <span
                                                            class="ml-1 bg-purple-200 dark:bg-purple-800 text-purple-800 dark:text-purple-200 px-1 py-0.5 rounded-full text-xs">
                                            ...
                                            @if (isset($sousAnalyses[$index]['children']) && count($sousAnalyses[$index]['children']) > 0)
                                                <div class="space-y-3 ml-4">
                                                    @foreach ($sousAnalyses[$index]['children'] as $cindex => $child)
                                                        <div
                                                            class="bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md p-3">
                                                            <div class="flex justify-between items-center mb-3">
                                                                <h6
                                                                    class="font-medium text-gray-800 dark:text-gray-200 text-xs">
                                                                    Sous-sous #{{ $cindex + 1 }}
                                                                </h6>
                                                            ...
                                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                                                                <div>
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        placeholder="Code">
                                                                    @error('sousAnalyses.' . $index . '.children.' .
                                                                        $cindex . '.code')
                                                                        <p
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <select
                                                                        wire:model="sousAnalyses.{{ $index }}.children.{{ $cindex }}.level"
                                                            ...
                                                            <div class="grid grid-cols-1 md:grid-cols-4 gap-2 mt-2">
                                                                <div>
                                                                    ...
                                                                    <select
                                                                        wire:model="sousAnalyses.{{ $index }}.children.{{ $cindex }}.examen_id"
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <select
                                                                        wire:model="sousAnalyses.{{ $index }}.children.{{ $cindex }}.type_id"
                                                                        class="w-full px-2 py-1 border border-gray-300 dark:border-gray-600 rounded focus:ring-1 focus:ring-purple-400 focus:border-purple-400 dark:bg-gray-700 dark:text-white text-xs">
                                                                        <option value="">Sélect.</option>
                                                                        @if ($types)
                                                                            @foreach ($types as $type)
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                                        ...
                                                                        <div class="space-y-4">
                                                                            <h4
                                                                                class="font-medium text-gray-900 dark:text-white flex items-center">
                                                                                <svg class="w-4 h-4 mr-2 text-orange-600"
                                                                                    fill="none"
                                                                                    stroke="currentColor"
                                                                                    viewBox="0 0 24 24">
                                                                                    <path stroke-linecap="round"
                                            ...
                                            @else
                                                <div
                                                    class="text-center py-4 text-gray-500 dark:text-gray-400 text-sm ml-4">
            ...
            <div class="flex space-x-4 pt-6 border-t border-gray-200 dark:border-gray-600">
                <button type="submit"
                    class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg flex items-center transition-colors font-medium">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <button type="button" wire:click="backToList"
                    class="bg-gray-300 dark:bg-gray-600 hover:bg-gray-400 dark:hover:bg-gray-500 text-gray-700 dark:text-white px-6 py-3 rounded-lg flex items-center transition-colors font-medium">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
