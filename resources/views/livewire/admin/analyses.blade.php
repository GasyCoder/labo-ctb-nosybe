            ...
            <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-3 lg:space-y-0 lg:space-x-3">
                <div class="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-4 order-2 lg:order-1">
                    ...
                    <div class="flex items-center space-x-2">
                        <label class="text-sm text-gray-600 whitespace-nowrap">Rechercher:</label>
                        <div class="relative">
                            <input type="text" 
                    ...
                    {{-- Filtre par examen --}}
                    <div class="flex items-center space-x-2">
                        <label class="text-sm text-gray-600 whitespace-nowrap">Examen:</label>
                        <select wire:model.live="selectedExamen" class="px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    {{-- Nombre par page --}}
                    <div class="flex items-center space-x-2">
                        <label class="text-sm text-gray-600 whitespace-nowrap">Par page:</label>
                        <select wire:model.live="perPage" class="px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    @if($selectedExamen || $search)
                        <button wire:click="resetFilters" class="px-3 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg text-sm transition-colors flex items-center" title="Réinitialiser tous les filtres">
                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full table-fixed">
                        <thead class="bg-gray-50 border-b border-gray-200">
                            <tr>
                                <th class="w-32 px-6 py-4 text-left font-medium text-gray-900">Code</th>
                                <th class="min-w-[200px] py-4 text-left font-medium text-gray-900">Désignation</th>
                                <th class="w-24 py-4 text-left font-medium text-gray-900">Type</th>
                                <th class="w-24 py-4 text-left font-medium text-gray-900">Examen</th>
                                <th class="w-24 py-4 text-right font-medium text-gray-900">Prix</th>
                                <th class="w-24 py-4 text-center font-medium text-gray-900">Statut</th>
                                <th class="w-32 py-4 text-center font-medium text-gray-900">Actions</th>
                            </tr>
                        </thead>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    <td class="px-6 py-4 w-32">
                                        <div class="flex items-center">
                                            ...
                                            <span class="font-mono text-sm font-medium 
                                                ...
                                                {{ $analyse->level === 'PARENT' ? 'text-purple-800' : '' }}
                                                {{ $analyse->level === 'CHILD' ? 'text-gray-600 text-xs' : '' }}">
                                                {{ $analyse->code }}
                                            </span>
                                        </div>
                                    </td>
                                    <td class="py-4 pr-4 min-w-[200px] max-w-[300px]">
                                        <div class="{{ $analyse->is_bold ? 'font-bold' : '' }}
                                            {{ $analyse->level === 'PARENT' ? 'text-purple-900 font-semibold' : '' }}
                                            {{ $analyse->level === 'CHILD' ? 'text-gray-600 text-sm pl-4' : '' }} truncate">
                                            {{ $analyse->designation }}
                                        </div>
                                        @if($analyse->description)
                                            <p class="text-xs text-gray-500 mt-1 truncate">{{ Str::limit($analyse->description, 60) }}</p>
                                        @endif
                                    </td>
                                    <td class="py-4 pr-4 w-24">
                                        @if($analyse->type)
                                            <span class="bg-indigo-100 text-indigo-800 px-2 py-1 rounded-full text-xs font-medium truncate block">
                                                {{ $analyse->type->name }}
                                            </span>
                                        @endif
                                    </td>
                                    <td class="py-4 pr-4 w-24">
                                        @if($analyse->examen)
                                            <span class="bg-gray-100 text-gray-800 px-2 py-1 rounded-md text-xs font-medium truncate block">
                                                {{ $analyse->examen->abr }}
                                            </span>
                                        @endif
                                    </td>
                                    <td class="py-4 text-right w-24">
                                        ...
                                        @else
                                            <span class="text-gray-400 text-sm whitespace-nowrap">Inclus</span>
                                        @endif
                                    </td>
            ...
            @else
                <div class="text-center py-12">
                    @if($search || $selectedExamen)
                        ...
                        <h5 class="text-xl font-medium text-gray-900 mb-2">Aucun résultat trouvé</h5>
                    ...
                    @else
                        ...
                        <h5 class="text-xl font-medium text-gray-900 mb-2">Aucune analyse trouvée</h5>
                        <p class="text-gray-600 mb-4">Commencez par créer votre première analyse.</p>
                ...
                <form wire:submit.prevent="store" class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="text" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('code') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror" 
                                   id="code" 
                                   wire:model="code"
                                   placeholder="Ex: GLY">
                            @error('code')
                        ...
                        <div>
                            ...
                            <select wire:model="level" 
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('level') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('designation') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror" 
                                   id="designation" 
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   step="0.01"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('prix') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror" 
                                   id="prix" 
                                   wire:model="prix"
                                   placeholder="0.00">
                            @error('prix')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div>
                            <label for="examen_id" class="block text-sm font-medium text-gray-700 mb-2">
                                Examen <span class="text-red-500">*</span>
                            </label>
                            <select wire:model="examen_id" 
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('examen_id') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <select wire:model="type_id" 
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('type_id') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label for="valeur_ref" class="block text-sm font-medium text-gray-700 mb-2">
                        ...
                        <div>
                            <label for="suffixe" class="block text-sm font-medium text-gray-700 mb-2">
                                Suffixe
                            </label>
                            <input type="text" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                    ...
                    <div class="flex items-center space-x-6">
                        <div class="flex items-center">
                            ...
                            <label for="is_bold" class="ml-2 text-sm text-gray-700">
                                Texte en gras
                            </label>
                        </div>
                ...
                <form wire:submit.prevent="update" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="text" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 @error('code') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror" 
                                   id="edit_code" 
                                   wire:model="code">
                            @error('code')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div>
                            <label for="edit_level" class="block text-sm font-medium text-gray-700 mb-2">
                                Niveau <span class="text-red-500">*</span>
                            </label>
                            <select wire:model="level" 
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 @error('level') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror">
                                <option value="PARENT">PARENT (Panel)</option>
                                <option value="NORMAL">NORMAL</option>
                                <option value="CHILD">CHILD (Sous-analyse)</option>
                            </select>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-4">
                        <div class="flex justify-between py-2 border-b border-gray-100">
                            ...
                            <span class="font-mono bg-gray-100 text-gray-800 px-2 py-1 rounded-md text-sm">{{ $analyse->code }}</span>
                        </div>
                        <div class="flex justify-between py-2 border-b border-gray-100">
                            <span class="font-medium text-gray-600">Désignation :</span>
                            <span class="font-medium text-gray-900 {{ $analyse->is_bold ? 'font-bold' : '' }}">{{ $analyse->designation }}</span>
                        </div>
                        <div class="flex justify-between py-2 border-b border-gray-100">
                            <span class="font-medium text-gray-600">Niveau :</span>
                            <span class="
                                @if($analyse->level === 'PARENT') bg-purple-100 text-purple-800
                                @elseif($analyse->level === 'NORMAL') bg-blue-100 text-blue-800
                        ...
                        <div class="flex justify-between py-2 border-b border-gray-100">
                            <span class="font-medium text-gray-600">Prix :</span>
                            <span class="font-bold text-green-600">{{ number_format($analyse->prix, 0, ',', ' ') }} Ar</span>
                        </div>
                        @if($analyse->parent)
                            <div class="flex justify-between py-2 border-b border-gray-100">
                                <span class="font-medium text-gray-600">Parent :</span>
                                <span class="text-gray-900">{{ $analyse->parent->code }} - {{ $analyse->parent->designation }}</span>
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="space-y-4">
                        <div class="flex justify-between py-2 border-b border-gray-100">
                            <span class="font-medium text-gray-600">Examen :</span>
                            <span class="bg-gray-100 text-gray-800 px-2 py-1 rounded-md text-sm">
                        ...
                        @if($analyse->valeur_ref)
                            <div class="flex justify-between py-2 border-b border-gray-100">
                                <span class="font-medium text-gray-600">Valeurs de référence :</span>
                                <span class="text-gray-900">{{ $analyse->valeur_ref }} {{ $analyse->unite }}</span>
                            </div>
                        @endif
                        <div class="flex justify-between py-2 border-b border-gray-100">
                ...
                @if($analyse->description)
                    <div class="mt-6 p-4 bg-gray-50 rounded-lg">
                        ...
                        <p class="text-gray-700">{{ $analyse->description }}</p>
                    </div>
                @endif

                @if($analyse->enfants && count($analyse->enfants) > 0)
                    <div class="mt-6">
                        <h4 class="font-medium text-gray-900 mb-4">Analyses enfants ({{ count($analyse->enfants) }})</h4>
                        <div class="space-y-2">
                            @foreach($analyse->enfants as $enfant)
                                <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                    <div>
                                        <span class="font-mono text-sm font-medium">{{ $enfant->code }}</span>
                                        <span class="ml-2 text-gray-700">{{ $enfant->designation }}</span>
                                    </div>
                                    <span class="text-sm text-gray-600">{{ number_format($enfant->prix, 0, ',', ' ') }} Ar</span>
                                </div>
                            @endforeach
                        </div>
                    </div>
