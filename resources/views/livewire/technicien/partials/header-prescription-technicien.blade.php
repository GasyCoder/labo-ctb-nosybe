<div class="bg-white dark:bg-slate-900 shadow-lg border-b border-slate-200 dark:border-slate-800">
    <div class="px-6 py-6">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                ...
                <div class="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-semibold border
                    ...
                    @else 
                        bg-slate-50 dark:bg-slate-800/30 text-slate-700 dark:text-slate-300 border-slate-200 dark:border-slate-700
                    @endif">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            {{-- Patient --}}
            <div class="group flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700 hover:border-primary-300 dark:hover:border-primary-500 transition-all duration-200 shadow-sm hover:shadow-md">
                <div class="flex-shrink-0 w-10 h-10 bg-primary-500 dark:bg-primary-600 rounded-lg flex items-center justify-center group-hover:scale-105 transition-transform duration-200 shadow">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="font-semibold text-slate-900 dark:text-slate-100 truncate">
                        {{ $prescription->patient->civilite. ' ' . $prescription->patient->nom }} {{ $prescription->patient->prenom }}
                    </p>
                    @if($prescription->patient->age)
                        <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">
                            {{ $prescription->patient->age }} {{ $prescription->patient->unite_age }}
                        </p>
                    @endif
                </div>
            </div>
            ...
            {{-- Prescripteur --}}
            <div class="group flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700 hover:border-green-300 dark:hover:border-green-500 transition-all duration-200 shadow-sm hover:shadow-md">
                <div class="flex-shrink-0 w-10 h-10 bg-green-500 dark:bg-green-600 rounded-lg flex items-center justify-center group-hover:scale-105 transition-transform duration-200 shadow">
                    <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    @if($prescription->prescripteur->specialite)
                        <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">
                            {{ $prescription->prescripteur->specialite }}
                        </p>
                    @endif
                </div>
            </div>
            ...
            {{-- Date --}}
            <div class="group flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700 hover:border-cyan-300 dark:hover:border-cyan-500 transition-all duration-200 shadow-sm hover:shadow-md">
                <div class="flex-shrink-0 w-10 h-10 bg-cyan-500 dark:bg-cyan-600 rounded-lg flex items-center justify-center group-hover:scale-105 transition-transform duration-200 shadow">
                    <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
