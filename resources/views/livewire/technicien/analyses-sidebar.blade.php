        ...
        <div class="p-3 space-y-2">
                    ...
                    <button type="button"
                            ...
                            class="w-full text-left p-2 pr-2 rounded-lg border transition-colors
                                   ...
                                   {{ $parent['status'] === 'TERMINE' 
                                      ...
                                      : ($parent['status'] === 'EN_COURS' ? 'bg-orange-50 border-orange-200' : 'bg-white') }}">
                        
                        <div class="flex items-start gap-3">
                            {{-- Indicateur de statut avec icônes appropriées --}}
                            <div class="flex-shrink-0 pt-1">
                                @if($parent['status'] === 'TERMINE')
                                    <div class="w-6 h-6 bg-green-600 rounded-md flex items-center justify-center">
                                        <svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
            ...
            @if(empty($analysesParents))
                <div class="text-center py-12">
                    ...
                    <p class="text-sm font-medium text-gray-600">Aucune analyse disponible</p>
                </div>
            @endif
        </div>
    </div>
