        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-2 px-3 py-1.5 bg-green-50 rounded-full border border-green-200">
                    ...
                    <span class="text-sm font-medium text-green-700">Système en ligne</span>
                </div>
            </div>
        </div>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @php
                                        ...
                                        $config = $statusConfig[$prescription->status] ?? ['bg' => 'bg-gray-100', 'text' => 'text-gray-800'];
                                    @endphp
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center">
                                    <div class="text-gray-500">
                                        ...
                                        <h3 class="text-lg font-medium text-gray-900 mb-1">Aucune prescription à traiter</h3>
                                        <p class="text-gray-600">Il n'y a actuellement aucune prescription correspondant aux critères sélectionnés.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
