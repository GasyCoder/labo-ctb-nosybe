                            ...
                            <div class="flex justify-between items-center p-2.5 border border-gray-200 dark:border-slate-600 rounded-lg 
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center space-x-2">
                                        <span class="px-1.5 py-0.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-200 rounded font-mono text-xs font-bold">
                                            {{ $analyse->code }}
                                        </span>
                                        <div>
                                            <span class="font-medium text-slate-800 dark:text-slate-100 text-sm">{{ $analyse->designation }}</span>
                ...
                @elseif(strlen($rechercheAnalyse) >= 2)
                    <div class="text-center py-6 bg-gray-50 dark:bg-slate-700 rounded-lg">
                        ...
                        @if(session('suggestions'))
                            <p class="text-yellow-600 dark:text-yellow-400 text-xs mt-1">{{ session('suggestions') }}</p>
                        @else
                            <p class="text-slate-500 dark:text-slate-400 text-xs mt-1">Essayez avec d'autres mots-clés</p>
                        @endif
                    </div>
                @else
