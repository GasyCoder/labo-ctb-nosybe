                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 w-10 h-10">
                                            <div class="w-10 h-10 rounded-full bg-gradient-to-br from-purple-400 to-purple-600 dark:from-purple-500 dark:to-purple-700 flex items-center justify-center shadow-lg">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            <div class="text-sm font-bold text-gray-900 dark:text-white">
                                                {{ $prescription->prescripteur->nom_complet ?? 'N/A' }}
                                            </div>
                                            <div class="text-xs text-gray-500 dark:text-gray-400">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <div class="flex justify-center space-x-2">
                                        <!-- Bouton Désarchiver -->
                                        <button 
                                            wire:click="confirmUnarchive({{ $prescription->id }})"
                                        ...
                                        <!-- Bouton Visualiser -->
                                        <button 
                                            wire:click="viewPrescription({{ $prescription->id }})"
                                        ...
                                        @if(auth()->check() && auth()->user()->isAdmin())
                                            <button 
                                                wire:click="confirmPermanentDelete({{ $prescription->id }})"
